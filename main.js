...
if (localStorage.getItem("defaultLevel")){
  ...
  settingLevels.value = localStorage.getItem("defaultLevel");
}
else {
  defaultLevel = "normal";
...
if (localStorage.getItem("defaultWordNumber")) {
  ...
  settingWordsNumber.value = localStorage.getItem("defaultWordNumber");
}
else {
...
settingWordsNumber.onchange = function() {
  ...
  localStorage.setItem("defaultWordNumber", settingWordsNumber.value);
  location.reload();
}
...
function timer(){
  ...
  let counter = setInterval(function(){
    ...
    window.onkeyup = function(e) {
      if (e.code === "Space" && input.value != "" && input.value != " ") {
        clearInterval(counter);
        checker();
      }
    }
